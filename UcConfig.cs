...
namespace DS.Web.UCenter
{
    ...
    public static class UcConfig
    {
        ...
        private static string getStringValue(string key, string defaultValue, bool checkEmpty)
        {
        ...
        /// <summary>
        /// getStringValue重载1无checkEmpty参数
        /// </summary>
        ...
        private static string getStringValue(string key, string defaultValue)
        {
            ...
            return getStringValue(key,defaultValue,checkEmpty);
        }
        /// <summary>
        /// getStringValue重载2既无checkEmpty参数，亦无defaultValue
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        ...
        private static bool getBoolValue(string key, bool defaultValue, bool checkEmpty)
        {
            var str = getValueTemp(key);
            if (checkEmpty && string.IsNullOrEmpty(str))
                throw new ConfigurationErrorsException(string.Format("缺少 {0} 的配置信息", key));
        ...
        /// <summary>
        /// getBoolValue的重载1，无checkEmpty参数
        /// </summary>
        /// <param name="key"></param>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        ...
        {
            bool checkEmpty = false;
            return getBoolValue(key,defaultValue,checkEmpty);
        }

        /// <summary>
        /// getBoolValue的重载2，既无checkEmpty参数，也无defaultValue参数
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        ...
        private static int getIntValue(string key, int defaultValue, bool checkEmpty)
        {
            var str = getValueTemp(key);
            if (checkEmpty && string.IsNullOrEmpty(str))
                throw new ConfigurationErrorsException(string.Format("缺少 {0} 的配置信息", key));
        ...
        {
            bool checkEmpty = false;
            return getIntValue(key,defaultValue,checkEmpty);
        }
        /// <summary>
        ///  getIntValue重载2，既无checkEmpty参数，也无defaultValue参数
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        ...
        {
            get { return getStringValue("UC_KEY","", true); }
        }
        ...
        public static string UcApi
        {
            get
            {
                var str = getStringValue("UC_API", "", true);
        ...
        public static string UcCharset
        {
            get
            {
                return getStringValue("UC_CHARSET", "", true);
            }
        }
        ...
        {
            get { return getStringValue("UC_APPID", "", true); }
        }
    }
}
