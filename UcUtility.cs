...
namespace DS.Web.UCenter
{
    ...
    public static class UcUtility
    {
        ...
        /// <returns></returns>
        private static string authCode(string sourceStr, AuthCodeMethod operation, string keyStr, int expiry)
        {
        ...
        private static string authCode(string sourceStr, AuthCodeMethod operation, string keyStr)
        {
            int expiry = 0;
            return authCode(sourceStr, operation, keyStr, expiry);
        }
        ...
        public static byte[] SubBytes(byte[] b, int start)
        {
            int length = int.MaxValue;
            return SubBytes(b, start, length);           
        }
