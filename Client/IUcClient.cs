...
namespace DS.Web.UCenter.Client
{
    ...
    public interface IUcClient
    {
        ...
        /// <returns></returns>
        UcUserRegister UserRegister(string userName, string passWord, string email, int questionId, string answer);
         UcUserRegister UserRegister(string userName, string passWord, string email, int questionId);
         UcUserRegister UserRegister(string userName, string passWord, string email);
        /// <summary>
        /// 用户登陆
        /// </summary>
        ...
        /// <param name="answer">答案</param>
        /// <returns></returns>
        UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques, int questionId, string answer);
        UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques, int questionId);
        UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques);
        UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod);
        UcUserLogin UserLogin(string userName, string passWord);
        /// <summary>
        /// 得到用户信息
        /// </summary>
        /// <param name="userName">用户名</param>
        ...
        /// </summary>
        /// <returns></returns>
        UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw, int questionId, string answer);
        UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw, int questionId);
        UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw);
        UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email);
        /// <summary>
        /// 删除用户
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        void PmReadStatus(int uid, int toUids, int pmIds, ReadStatus readStatus);
        void PmReadStatus(int uid, int toUids, int pmIds);
        void PmReadStatus(int uid, int toUids);
        /// <summary>
        /// 修改阅读状态
        /// </summary>
        /// <param name="uid">发件人</param>
        ...
        /// <param name="readStatus">阅读状态</param>
        void PmReadStatus(int uid, IEnumerable<int> toUids, IEnumerable<int> pmIds, ReadStatus readStatus);
        void PmReadStatus(int uid, IEnumerable<int> toUids, IEnumerable<int> pmIds);
        /// <summary>
        /// 获取短消息列表
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        /// <returns></returns>
        UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder, PmReadFilter filter, int msgLen);
        UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder, PmReadFilter filter);
        UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder);
        UcPmList PmList(int uid, int page, int pageSize);
        UcPmList PmList(int uid, int page);
        UcPmList PmList(int uid);
        /// <summary>
        /// 获取短消息内容
        ...
        /// <returns></returns>
        UcPmView PmView(int uid, int pmId, int toUid, DateRange dateRange);
        UcPmView PmView(int uid, int pmId, int toUid);
        UcPmView PmView(int uid, int pmId);
        /// <summary>
        /// 获取单条短消息内容
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        /// <param name="pmId">短消息ID</param>
        /// <returns></returns>
        UcPm PmViewNode(int uid, ViewType type, int pmId);
        UcPm PmViewNode(int uid, ViewType type);
        UcPm PmViewNode(int uid);
        /// <summary>
        /// 忽略未读消息提示
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        bool FriendAdd(int uid, int friendId);
        /// <summary>
        /// 删除好友
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        int FriendTotalNum(int uid, FriendDirection direction);
        int FriendTotalNum(int uid);
        /// <summary>
        /// 好友列表
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        /// <param name="direction">方向</param>
        /// <returns></returns>
        UcFriends FriendList(int uid, int page, int pageSize, int totalNum, FriendDirection direction);
        UcFriends FriendList(int uid, int page, int pageSize, int totalNum);
        UcFriends FriendList(int uid, int page, int pageSize);
        UcFriends FriendList(int uid, int page);
        UcFriends FriendList(int uid);
        /// <summary>
        /// 积分兑换请求
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        ///<returns></returns>
        string Avatar(int uid, AvatarType type);
        string Avatar(int uid);
        /// <summary>
        /// 得到头像地址
        /// </summary>
        /// <param name="uid">Uid</param>
        ...
        /// <param name="type">类型</param>
        /// <returns></returns>
        string AvatarUrl(int uid,AvatarSize size,AvatarType type);
        string AvatarUrl(int uid,AvatarSize size);
        /// <summary>
        /// 检查头像是否存在
        /// </summary>
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        bool AvatarCheck(int uid, AvatarSize size, AvatarType type);
        bool AvatarCheck(int uid, AvatarSize size);
        bool AvatarCheck(int uid);
        /// <summary>
        /// 获取标签数据
        /// </summary>
