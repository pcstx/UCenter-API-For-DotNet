...
namespace DS.Web.UCenter.Client
{
    ...
    public class UcClient : UcClientBase, IUcClient
    {
        ...
        /// <returns></returns>
        public UcUserRegister UserRegister(string userName, string passWord, string email, int questionId, string answer)
        {
        ...
        public UcUserRegister UserRegister(string userName, string passWord, string email, int questionId)
        {
            string answer = "";
            return UserRegister(userName,passWord,email,questionId,answer);           
        }

        public UcUserRegister UserRegister(string userName, string passWord, string email)
        {
            int questionId = 0;
            string answer = "";
            return UserRegister(userName,passWord,email,questionId,answer);  
        ...
        /// <param name="answer">答案</param>
        /// <returns></returns>
        public UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques, int questionId, string answer)
        {
            var args = new Dictionary<string, string>
                           {
                               {"username", userName},
        ...
        public UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques, int questionId)
        {
            string answer = "";
            return UserLogin(userName,passWord,loginMethod,checkques,questionId,answer);
        }

        public UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod, bool checkques)
        {
            int questionId = 0;
            string answer = "";
            return UserLogin(userName,passWord,loginMethod,checkques,questionId,answer);
        ...
        public UcUserLogin UserLogin(string userName, string passWord, LoginMethod loginMethod)
        {
            bool checkques = false;
            int questionId = 0;
            string answer = "";
            return UserLogin(userName,passWord,loginMethod,checkques,questionId,answer);
        }

        public UcUserLogin UserLogin(string userName, string passWord)
        {
            LoginMethod loginMethod = LoginMethod.UserName;
            bool checkques = false;
            int questionId = 0;
            string answer = "";
            return UserLogin(userName,passWord,loginMethod,checkques,questionId,answer);
        ...
        /// </summary>
        /// <returns></returns>
        public UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw, int questionId, string answer)
        {
            var args = new Dictionary<string, string>
                           {
                               {"username", userName},
        ...
        public UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw, int questionId)
        {
             string answer = "";
            return UserEdit(userName, oldPw, newPw, email, ignoreOldPw, questionId, answer);            
        }


        public UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email, bool ignoreOldPw)
        {
              int questionId = 0;
             string answer = "";
            return UserEdit(userName, oldPw, newPw, email, ignoreOldPw, questionId, answer);   
        ...
        public UcUserEdit UserEdit(string userName, string oldPw, string newPw, string email)
        {
        ...
        /// <returns></returns>
        private UcPmSend pmSend(int fromUid, string msgTo, string subject, string message, int replyPmId, SendMethod sendMethod)
        {
            var args = new Dictionary<string, string>
                           {
        ...
        private UcPmSend pmSend(int fromUid, string msgTo, string subject, string message, int replyPmId)
        {
             SendMethod sendMethod = SendMethod.Uid;
            return pmSend(fromUid,msgTo,subject, message, replyPmId, sendMethod);
        }

        private UcPmSend pmSend(int fromUid, string msgTo, string subject, string message)
        {
             int replyPmId = 0; 
            SendMethod sendMethod = SendMethod.Uid;
            return pmSend(fromUid,msgTo,subject, message, replyPmId, sendMethod);
        ...
        public void PmReadStatus(int uid, int toUids, int pmIds, ReadStatus readStatus)
        {
            PmReadStatus(uid, new[] { toUids }, new[] { pmIds }, readStatus);
        }

        public void PmReadStatus(int uid, int toUids, int pmIds)
        {
            ReadStatus readStatus = ReadStatus.Readed;
            PmReadStatus(uid,toUids, pmIds,readStatus);            
        }

        public void PmReadStatus(int uid, int toUids)
        {
            int pmIds = 0;
            ReadStatus readStatus = ReadStatus.Readed;
            PmReadStatus(uid,toUids, pmIds,readStatus);          
        ...
        /// <param name="readStatus">阅读状态</param>
        public void PmReadStatus(int uid, IEnumerable<int> toUids, IEnumerable<int> pmIds, ReadStatus readStatus)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public void PmReadStatus(int uid, IEnumerable<int> toUids, IEnumerable<int> pmIds )
        {
            ReadStatus readStatus = ReadStatus.Readed;
            PmReadStatus(uid, toUids, pmIds, readStatus);            
        }
        ...
        /// <returns></returns>
        public UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder, PmReadFilter filter, int msgLen)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder, PmReadFilter filter)
        {
            int msgLen = 0;
            return PmList(uid, page, pageSize, folder, filter,msgLen);
        }

        public UcPmList PmList(int uid, int page, int pageSize, PmReadFolder folder)
        {
            PmReadFilter filter = PmReadFilter.NewPm;
            int msgLen = 0;
            return PmList(uid, page, pageSize, folder, filter,msgLen);
        }

        public UcPmList PmList(int uid, int page, int pageSize)
        {
             PmReadFolder folder = PmReadFolder.NewBox;
             PmReadFilter filter = PmReadFilter.NewPm;
            int msgLen = 0;
            return PmList(uid, page, pageSize, folder, filter,msgLen);
        }

         public UcPmList PmList(int uid, int page)
        {
             int pageSize = 10;
             PmReadFolder folder = PmReadFolder.NewBox;
             PmReadFilter filter = PmReadFilter.NewPm;
        ...
        public UcPmList PmList(int uid)
        {
            int page = 1;
            int pageSize = 10;
             PmReadFolder folder = PmReadFolder.NewBox;
        ...
        /// <returns></returns>
        public UcPmView PmView(int uid, int pmId, int toUid, DateRange dateRange)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public UcPmView PmView(int uid, int pmId, int toUid)
        {
            DateRange dateRange = DateRange.Today;
            return PmView(uid,pmId,toUid,dateRange);            
        }

        public UcPmView PmView(int uid, int pmId)
        {
            int toUid = 0;
            DateRange dateRange = DateRange.Today;
            return PmView(uid,pmId,toUid,dateRange);               
        ...
        /// <param name="pmId">短消息ID</param>
        /// <returns></returns>
        public UcPm PmViewNode(int uid, ViewType type, int pmId)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public UcPm PmViewNode(int uid, ViewType type)
        {
            int pmId = 0;
            return PmViewNode(uid, type, pmId);
        }

        public UcPm PmViewNode(int uid)
        {
            ViewType type = ViewType.Specified;
            int pmId = 0;
            return PmViewNode(uid, type, pmId);            
        }
        ...
        public bool FriendAdd(int uid, int friendId, string comment)
        {
         ...
         public bool FriendAdd(int uid, int friendId)
        {
             string comment = "";
             return FriendAdd(uid,friendId, comment);
        }
        ...
        public int FriendTotalNum(int uid, FriendDirection direction)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public int FriendTotalNum(int uid)
        {
            FriendDirection direction = FriendDirection.All;
            return FriendTotalNum(uid,direction);            
        }
        /// <summary>
        /// 好友列表
        /// </summary>
        ...
        /// <param name="direction">方向</param>
        /// <returns></returns>
        public UcFriends FriendList(int uid, int page, int pageSize, int totalNum, FriendDirection direction)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public UcFriends FriendList(int uid, int page, int pageSize, int totalNum)
        {            
            FriendDirection direction = FriendDirection.All;
            return FriendList(uid,page,pageSize,totalNum,direction);
        }

        public UcFriends FriendList(int uid, int page, int pageSize)
        {            
            int totalNum = 10;
            FriendDirection direction = FriendDirection.All;
            return FriendList(uid,page,pageSize,totalNum,direction);
        ...
        public UcFriends FriendList(int uid, int page)
        {
            int pageSize = 10;
            int totalNum = 10;
            FriendDirection direction = FriendDirection.All;
        ...
        public UcFriends FriendList(int uid)
        {
           int page = 1;
            int pageSize = 10;
            int totalNum = 10;
        ...
        ///<returns></returns>
        public string Avatar(int uid, AvatarType type)
        {
            var args = new Dictionary<string, string>
                           {
                                {"uid" ,uid.ToString()}
        ...
        public string Avatar(int uid)
        {
            AvatarType type = AvatarType.Virtual;
           return Avatar(uid, type);
        }
        ...
        /// <param name="type">类型</param>
        /// <returns></returns>
        public string AvatarUrl(int uid,AvatarSize size,AvatarType type)
        {
            return string.Format("{0}avatar.php?uid={1}&type={2}&size={3}", UcConfig.UcApi, uid,
                                 type.ToString().ToLower(), size.ToString().ToLower());
        }

        public string AvatarUrl(int uid,AvatarSize size)
        {
            AvatarType type = AvatarType.Virtual;
            return AvatarUrl(uid,size,type);            
        }
        ...
        /// <param name="type"></param>
        /// <returns></returns>
        public bool AvatarCheck(int uid, AvatarSize size, AvatarType type)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public bool AvatarCheck(int uid, AvatarSize size)
        {            
            AvatarType type = AvatarType.Virtual;
            return AvatarCheck(uid, size, type);
        }

        public bool AvatarCheck(int uid)
        {
            AvatarSize size = AvatarSize.Middle;
            AvatarType type = AvatarType.Virtual;
            return AvatarCheck(uid, size, type);
        }
