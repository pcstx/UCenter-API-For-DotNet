...
namespace DS.Web.UCenter
{
    ...
    public abstract class UcItemReturnBase : UcItemBase
    {
        ...
        /// <returns></returns>
        private string serialize(bool htmlOn, bool isRoot)
        {
            return serialize(Data,htmlOn,isRoot);
        }

        private string serialize(bool htmlOn)
        {           
            bool isRoot = true;
            return serialize(htmlOn,isRoot);            
        }
        ...
        /// <returns></returns>
        private string serialize(IDictionary item,bool htmlOn, bool isRoot)
        {            
        ...
        private string serialize(IDictionary item,bool htmlOn)
        {
            bool isRoot = true;
            return serialize(item,htmlOn,isRoot);
        }

        private string serialize(IDictionary item)
        {
            bool htmlOn = true;
            bool isRoot = true;
            return serialize(item,htmlOn,isRoot);            
