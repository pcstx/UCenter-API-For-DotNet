...
namespace DS.Web.UCenter
{
    ...
    static class DictionaryExtension
    {
        ...
        /// <returns></returns>
        static public bool GetBool(this IDictionary data, string key, string compare)
        {
        ...
        static public bool GetBool(this IDictionary data, string key)
        {
            string compare = "1";
            return GetBool(data, key, compare);            
        }
        ...
        static public DateTime GetDateTime(this IDictionary data, string key)
        {
            ...
            if (data != null)
            {
                ...
                { 
                    ...
                    if (dataValue != null)
                    {
                        result = UcUtility.PhpTimeToDateTime(long.Parse(dataValue.ToString()));
                    } 
                } 
            }
